...
func (in *AdditionalVolumeAndMounts) DeepCopyInto(out *AdditionalVolumeAndMounts) {
	*out = *in
	if in.Volumes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalVolumeAndMounts.
func (in *AdditionalVolumeAndMounts) DeepCopy() *AdditionalVolumeAndMounts {
	if in == nil {
		return nil
	}
	out := new(AdditionalVolumeAndMounts)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterStorage) DeepCopyInto(out *ClusterStorage) {
	*out = *in
	...
	in.AdditionalVolumeAndMounts.DeepCopyInto(&out.AdditionalVolumeAndMounts)
}
